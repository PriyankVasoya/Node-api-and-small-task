          ...
          <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
            ...
            <tr>
              <td valign="middle" class="hero bg_white"
                style="background-image: url(); background-size: cover; height: 250px;">
                  ...
                  <tr>
                    <td class="bg_white" style="padding: 50px 50px 30px">
                      <div class="heading-section" style="text-align: center; padding: 0 30px;">
                        <a href="${result.encoded_user_id}" class="btn btn-primary">Confirm Account</a>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td class="bg_white email-section">
                      <div class="heading-section" style="text-align: left; padding: 0 30px;">
                        ...
                        <p><a href="${result.encoded_user_id}">${result.encoded_user_id}</a></p>
                      ...
                      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                          <td style="text-align: center; padding-left: 5px; padding-right: 5px;">
                            ...
                            <p><a href="${result.encoded_user_id}" style="color: rgba(76, 0, 255, 0.4);">Unsubscribe</a></p>
                          </td>
                        </tr>
                      </table>
                    </td>
...
exports.contactus = function(result,callback)
{
    ...
    <head>
      ...
      <title>${GLOBALS.APP_NAME} - Contact Us</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                  ...
                  <tr>
                    <td>
                      <div class="text" style="padding: 0 2.5em; text-align: center;">
                        ...
                        <p style="color: #ffffff;">Thank you for contacting Support at ${GLOBALS.APP_NAME}!</p>
